...
const PrimaryBtn = ({ icon, text }: Props) => {
  return (
    <motion.button
      whileHover={{ scale: 1.01 }}
      whileTap={{ scale: 1 }}
      onClick={() => (window.location.href = "tel:+38640517788")}
      className="group relative z-10 flex min-h-10 items-center justify-center gap-x-3 overflow-hidden rounded bg-[#317c4e] px-8 py-4 text-xl text-white duration-1000 hover:text-white md:min-h-12 lg:min-h-14"
    >
