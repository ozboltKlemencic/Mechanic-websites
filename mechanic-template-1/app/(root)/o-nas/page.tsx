      ...
      <div className=" flex h-auto w-full items-center justify-center bg-green-100/20">
        <div className="relative flex size-full  flex-col items-center justify-center gap-x-16 py-20 md:w-[1220px] lg:flex-row">
          ...
          >
            ...
            <Link href="https://www.google.com/maps/place/Trfsf+cesta+1">
              <address className="primary-text-gradient mb-2 font-Hind text-lg font-medium hover:underline">
                Tržaška cesta 1, 1000 Podlipa, Slovenija
              </address>
            </Link>
            <p className="mt-2 font-Hind text-lg text-gray-500">
              Nahajamo se v bližini Vrhnike in Žirov, na Tržaški cesti 1,
              enostavno dostopni iz širše okolice. Naša lokacija je primerna
              tako za voznike, ki prihajajo z osebnim avtomobilom, kot za tiste,
              ki uporabljajo javne prevoze. Zagotavljamo dovolj parkirnih mest
              za vaša vozila. Obiščite nas v avtoservisu AS Klemencič za
              vrhunske storitve, kot so hitri servis, menjava gum, diagnostika
              vozil in čiščenje avtomobilov. Naša strokovna ekipa vam bo z
              veseljem pomagala pri ohranjanju vašega vozila v najboljšem
              stanju.
            </p>
            <p className="mt-2 font-Hind text-lg text-gray-500">
