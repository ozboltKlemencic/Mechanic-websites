        ...
        >
          ...
          <div className="flex w-full items-center justify-center">
            <div className="flex w-[92%] flex-col items-center justify-center gap-y-4 pb-12 md:mx-4 md:gap-y-6 lg:max-w-screen-xl lg:gap-y-8">
              ...
              >
                Za hitri servis v Vrhniki, Logatcu, Logatec ali Žirih se lahko
                preprosto naročite preko telefona ali spletne strani. Naročanje
                je hitro, postopek pa udoben in brezskrbni. Poskrbite za svoje
                vozilo in ga pripeljite na pregled, kjer bomo izvedli vse
                potrebne storitve, kot so priprava avtomobila na tehnični
                pregled, menjava olja in čistilcev, menjava oljnega filtra,
                menjava zračnega filtra, menjava žarnic, menjava akumulatorja,
                menjavo akomulatorja, menjava sklopk, menjava kabinskega filtra,
                menjava brisalcev, menjava zavor, menjava filtra goriva in
                diagnostika vozila. Naš cilj je, da vam zagotovimo hitro in
                učinkovito storitev.
              </motion.p>
            </div>
          </div>
            ...
            <div className="flex w-screen flex-col flex-wrap items-center justify-center gap-4 md:max-w-[1300px] md:flex-row md:items-start md:px-4 ">
              ...
              <div className="card-shadow-2 flex w-[95%] flex-col  items-start justify-start gap-y-4 rounded-md  border border-black/10 p-8 shadow-md transition-all duration-300 hover:translate-x-1 md:min-h-[440px] md:w-full lg:min-h-[530px] lg:w-[calc(50%-0.5rem)] lg:max-w-none">
                ...
                >
                  ...
                  servisiranje ter nego vašega vozila, še posebej na lokaciji
                  vrhnika. Pri nas na Vrhniki, Logatcu in Žirih vam ponujamo
                  širok spekter hitrih servisnih storitev. Naša ekipa
                  avtomehanikov vam zagotavlja visoko kakovost storitev brez
                  dolgega čakanja. Nudimo menjavo motornega olja, pregled
                  vozila, menjava oljnega filtra, menjava zračnega filtra,
                  menjavo kabinskega filtra, menjavo brisalcev, menjava
                  akomulatorja, menjava filtra goriva, nujna popravila,
                  vzdrževanje, popravilo in priprava avtomobila na tehnični
                  pregled. Vse storitve so izvedene hitro in strokovno, tako da
                  boste lahko hitro nadaljevali svojo vožnjo.
                </motion.p>
              </div>
              ...
              <div className="card-shadow-2 flex w-[95%] flex-col items-start justify-start gap-y-4 rounded-md border border-black/10 p-8 shadow-md transition-all duration-300 hover:translate-x-1 md:min-h-[440px] md:w-full lg:min-h-[330px] ">
                ...
                >
                  ...
                  proizvajalca. Če ste v Žireh ali okolici, se naročite na hitri
                  servis v Žireh še danes in omogočite svojemu vozilu vrhunsko
                  oskrbo!
                </motion.p>
              </div>
              <div className="card-shadow-2 flex w-[95%] flex-col items-start justify-start gap-y-4 rounded-md border border-black/10 p-8 shadow-md transition-all duration-300 hover:translate-x-1 md:min-h-[440px] md:w-full lg:min-h-[330px] ">
                ...
                <motion.p
                  ...
                  className="text-left font-Hind text-base text-black/80 md:text-lg lg:text-xl"
                >
                  Hitro, ugodno in strokovno V naši mehanični delavnici v Žireh
                  vam nudimo celovito storitev hitrega servisa, ki vključuje:
                  ...
                  nadaljnjega vzdrževanja vašega vozila. Naš hitri servis Žiri
                  je primeren za vse vrste osebnih vozil. Z našo pomočjo bo vaše
                  ...
                  hitri servis v Žireh Ne odlašajte – rezervirajte svoj termin
                  za hitri servis pri nas še danes! Prepričajte se, zakaj smo
                  prva izbira za hitri servis v Žireh. Poskrbeli bomo, da bo
                  vaše vozilo pripravljeno na vsako pot. Vaše zadovoljstvo in
                  brezhibno delovanje vozila sta naša prioriteta!
                </motion.p>
              </div>
            </div>
          </div>
