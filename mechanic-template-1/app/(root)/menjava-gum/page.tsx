      ...
      <section>
        <div className="flex w-screen flex-col items-center justify-center pb-2 pt-16  md:pb-4 md:pt-20  lg:pb-10 lg:pt-32 ">
          <div className="flex w-[95%] flex-col items-center justify-center gap-y-4 md:mx-4 md:gap-y-6 lg:max-w-screen-xl lg:gap-y-8">
            ...
            >
              Dobro vzdrževane in pravilno nameščene{" "}
              <strong className="primary-text-gradient">pnevmatike</strong> so
              temelj varne vožnje. V{" "}
              <strong className="primary-text-gradient">
                {" "}
                okolici Vrhnike oz. Žirov{" "}
              </strong>{" "}
              vam ponujamo visokokakovostne{" "}
              <strong className="primary-text-gradient">pnevmatike</strong> in
              profesionalno{" "}
              <strong className="primary-text-gradient">menjavo gum</strong>, ki
              zagotavljajo vašo varnost na cesti. Naša predanost kakovosti in
              natančnosti pomeni, da boste vedno varno potovali, ne glede na
              vremenske razmere ali cestne izzive. Ne glede na to, ali
              potrebujete{" "}
              <strong className="primary-text-gradient">
                letne pnevmatike
              </strong>{" "}
              ...
              ali samo{" "}
              <span className="primary-text-gradient">menjavo gum</span> na{" "}
              <span className="primary-text-gradient">Vrhniki</span>, smo vaša
              prva izbira. Obiščite nas in izkoristite našo strokovno storitev
              ter se prepričajte, da so vaše{" "}
              <span className="primary-text-gradient">pnevmatike</span>
              vedno v optimalnem stanju za varno vožnjo.
            </motion.p>
          </div>
        </div>
      </section>
        ...
        <div className="flex w-screen flex-col items-center justify-center pb-2 pt-16  md:pb-4 md:pt-20  lg:pb-10 lg:pt-32 ">
          <div className="flex w-[95%] flex-col items-center justify-center gap-y-4 md:mx-4 md:gap-y-6 lg:max-w-screen-xl lg:gap-y-8">
            ...
            <motion.p
              ...
              className=" text-center font-Hind text-base text-black/80 md:text-lg lg:text-xl"
            >
              Naše storitve nudimo v Žireh , kjer je tudi naš žiri, in Vrhniki ,
              kjer poskrbimo za celovito oskrbo vašega avtomobila. Poleg menjava
              gum in svetovanja za gume za avto ponujamo še: - Diagnostiko vozil
              - Hitri servis - Centriranje koles Za več informacij nas
              kontaktirajte. Naš avtomehanik vam bo z veseljem pomagal.
            </motion.p>
            <motion.p
              initial={{ opacity: 0, x: -5 }}
              transition={{ duration: 1 }}
