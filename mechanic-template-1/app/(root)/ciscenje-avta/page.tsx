      ...
      <section>
        <div className="flex w-screen flex-col items-center justify-center pb-2 pt-16  md:pb-4 md:pt-20  lg:pb-10 lg:pt-32 ">
          <div className="flex w-[95%] flex-col items-center justify-center gap-y-4 md:mx-4 md:gap-y-6 lg:max-w-screen-xl lg:gap-y-8">
            ...
            >
              V AS Klemencič, vaši avtomehanični delavnici v Vrhniki in Žirih,
              ponujamo vrhunske storitve za ciscenje avtomobila, tudi za tisto
              zahtevnejše ciscenje, kot je ciscenje avtomobila, ki povrne vozilu
              popoln videz. Naša ekipa strokovnjakov poskrbi za notranje in
              zunanje ciscenje vozil, da vašemu vozilu povrnemo sijaj in svežino
              s celovitim čiscenje avtomobila, vključno s čiščenjem vozila ter
              storitvijo globinsko čiščenje. Z uporabo kakovostnih čistilnih
              sredstev, napredne opreme ter skrbnega pristopa vam zagotavljamo
              dolgotrajno zaščito in izboljšanje videza vašega avtomobila,
              vključno s storitvijo ciscenje avta po zimi.
            </motion.p>
          </div>
        </div>
      </section>
            ...
            <div className="flex w-screen flex-col flex-wrap items-center justify-center gap-4 md:max-w-[1300px] md:flex-row md:items-start md:px-4 ">
              ...
              <div className="card-shadow-2 flex w-[95%] flex-col items-start justify-start gap-y-4 rounded-md border border-black/10 p-8 shadow-md transition-all duration-300 hover:translate-x-1 md:min-h-[440px] md:w-full lg:min-h-[330px] ">
                ...
                >
                  ...
                  čiscenje, vključno z čiscenje avtomobila v žireh, notranje
                  čiscenje, zunanje pranje avtomobila, ročno pranje avtomobila,
                  poliranje avtomobila, čiščenje klimatske naprave v avtu,
                  čiščenje avta po zimi, avtomobilska nega in storitve avto
                  servisa, poskrbi za udobno in zdravo vozno okolje, ki je
                  pomembno za vaše dobro počutje med vožnjo.
                </motion.p>
              </div>
              <div className="card-shadow-2 flex w-[95%] flex-col items-start justify-start gap-y-4 rounded-md border border-black/10 p-8 shadow-md transition-all duration-300 hover:translate-x-1 md:min-h-[440px] md:w-full lg:min-h-[330px] ">
                <motion.h2
                ...
                >
                  ...
                  Lokalna prisotnost: Na voljo smo vam v Vrhniki in Žirih, kjer
                  boste vedno dobro poskrbljeni, vključno s storitvijo čiščenje
                  avtomobila v Žirih. Poskrbite za vaš avto z uporabo storitev
                  avto servis in uživajte v čisti in prijetni vožnji, ki
                  vključuje tudi čiščenja avtomobila!
                </motion.p>
              </div>
            </div>
          </div>
